...
int main()
{
    ...
    char T_cin[50][12],T_NP[50][20],temp_cin[12],temp_NP[20];
    start:
    do {
...
switch (choix_compt)
    {
        ...
        printf("SVP entre votre NOM et PRENOM :");
        scanf("%s",T_NP[nb_compt]);
        printf("SVP entre votre CIN :");
        scanf("%s",T_cin[nb_compt]);
        printf("SVP entre votre Montant :");
    ...
    {
        printf("*\ndonner le nom pour le compte %d :",i+1);
        scanf("%s",T_NP[nb_compt]);
        printf("donner cin pour le compte %d :",i+1);
        scanf("%s",T_cin[nb_compt]);
        printf("donner le montent du le compte :");
        scanf("%lf",&T_Montant[nb_compt]);
        nb_compt++;
    }
    ...
    case 3 : // les operation
{
        ...
        else {printf("le compte tu es choisi est : %s %s %lf\n\n",T_NP[Z],T_cin[Z],T_Montant[Z]);
        do
        {
                    ...
                    for(i=0;i<nb_compt;i++)
                    {
                        for(j=i+1;j<nb_compt;j++)
                        {
                            if(T_Montant[i]>T_Montant[j])
                            {
                                ...
                                strcpy (temp_cin,T_cin[j]);
                                strcpy(temp_NP,T_NP[j]);
                                ...
                                strcpy(T_cin[i],temp_cin);
                                strcpy(T_NP[i],temp_NP);
                            }
                        }
                    }
                }
